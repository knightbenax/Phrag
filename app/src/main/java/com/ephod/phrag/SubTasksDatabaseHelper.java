...
public final class SubTasksDatabaseHelper {
	Context m = null;
	...
	public SubTasksDatabaseHelper(Context context){
		m = context;
	...
	public void getSingleTask(String id, String Task, String TaskId, String TaskDate){
	...
	public void getAllTasks(List<String> tasks, List<String> taskIds, List<String> taskDates){ //we would populate the List Array that holds the tasks and the List Array that holds the id from here
		...
		if(cursor.moveToFirst()){
			do{
				...
				taskDates.add(cursor.getString(2)); //add the content of the task
